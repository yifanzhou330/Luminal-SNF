...
library(export)
library(ggpubr)
load("/Users/ZYF/Desktop/研究生科研/研一/lumianl平台建立/生信分析/30.NG修改/rawdata/CBCGA_HRposHER2neg351_WES_RNAseq_CNV_Metab_Protein_20221010.Rdata")
################################
# data preapre 
################################
# cnv
...
all(rownames(cnv) == rownames(exp.fpkm.TT.log.SD2k)) # make sure all the samples are in the same order for the three data sets 
...
K = 15;		# number of neighbors, usually (10~30)    15
alpha = 0.5;  	# hyperparameter, usually (0.3~0.8) 0.5
T = 20; 	# Number of Iterations, usually (10~20)   20
